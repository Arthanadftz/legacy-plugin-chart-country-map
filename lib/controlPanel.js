...
var _default = {
  controlPanelSections: [{
    ...
    controlSetRows: [[{
      ...
      config: {
        type: 'SelectControl',
        label: (0, _core.t)('Country Name'),
        default: 'France',
        choices: ['Belgium', 'Brazil', 'Bulgaria', 'China', 'Egypt', 'France', 'Germany', 'India', 'Iran', 'Italy', 'Japan', 'Korea', 'Liechtenstein', 'Morocco', 'Myanmar', 'Netherlands', 'Portugal', 'Russia', 'Singapore', 'Spain', 'Switzerland', 'Thailand', 'Timorleste', 'Uk', 'Ukraine', 'Usa', 'Zambia'].map(s => [s, s]),
        description: (0, _core.t)('The name of the country that Superset should display')
      }
    }, {
      name: 'number_format',
      config: {
